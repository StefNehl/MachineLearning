...
\author{
	...
	\textsuperscript{1}\textit{stefan-christopher.nehl@stud.unileoben.ac.at}, \institution{Montanuniversität Leoben, Austria}\\ % Institution 1
...
\lettrineabstract{In the first assignment, I had to create an algorithm for calculating the Fibonacci sequence and plotting the values from 1 to 30. Furthermore, I made a report in Latex, using the template provided by the Institute and submitted the results.}
...
Fibonacci class: 
\lstinputlisting{../Source/Code/Fibonacci.py}
\newpage

Plotting of the values:
\lstinputlisting{../Source/Code/Assignment_1.py}
